              ...
              try {
                  ...
                  if ($userPhoto) {
                      try {
                          ...
                          $analysis = (Invoke-RestMethod -Uri ("https://$EXAMPLE_SECRET_VALUE_PLACEHOLDER/vision/v3.1/analyze?visualFeatures=Categories,Adult,Tags,Description,Faces,Color,ImageType,Objects&details=Celebrities&language=en") `
                                  -Headers $headers `
                                  -Body ($userPhoto) `
