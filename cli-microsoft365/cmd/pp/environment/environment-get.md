...
<Tabs>
  ...
  ```csv
  name,id
  EXAMPLE_SECRET_VALUE_PLACEHOLDER,/providers/Microsoft.BusinessAppPlatform/environments/EXAMPLE_SECRET_VALUE_PLACEHOLDER
  ```
  ...
  ```md
  # pp environment get --name EXAMPLE_SECRET_VALUE_PLACEHOLDER
