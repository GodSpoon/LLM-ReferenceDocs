...
```sh
m365 outlook calendar list --userId b743445a-112c-4fda-9afd-05943f9c7b36 --calendarGroupId "EXAMPLE_SECRET_VALUE_PLACEHOLDER="
```
...
<Tabs>
  ...
  id                                                                                                                                                        name
  --------------------------------------------------------------------------------------------------------------------------------------------------------  ----------------------
  EXAMPLE_SECRET_VALUE_PLACEHOLDER=  Calendar
  ```
  ...
  EXAMPLE_SECRET_VALUE_PLACEHOLDER=,Calendar,auto,,0006f0b7-0000-0000-c000-000000000046,1,KKQ3ZlF2PE2iyZOQgi6OMwAAAAADcg==,1,1,1,teamsForBusiness,1,0
  ```
  ...
  ## Calendar (EXAMPLE_SECRET_VALUE_PLACEHOLDER=)
