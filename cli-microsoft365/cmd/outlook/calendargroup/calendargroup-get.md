...
```sh
m365 outlook calendargroup get --id "EXAMPLE_SECRET_VALUE_PLACEHOLDER=" --userId "44288f7d-7710-4293-8c8e-36f310ed2e6a"
```
...
<Tabs>
  ...
  id                                                                                                                       name
  -----------------------------------------------------------------------------------------------------------------------  ----------------
  EXAMPLE_SECRET_VALUE_PLACEHOLDER=  My Calendars
  ```
