...
- [outlook calendar list](../cmd/outlook/calendar/calendar-list.mdx) - retrieves a list of all calendars of a user or group [#7075](https://github.com/pnp/cli-microsoft365/issues/7075)

**SharePoint:**

- [spo file unarchive](../cmd/spo/file/file-unarchive.mdx) - Unarchives a file [#7176](https://github.com/pnp/cli-microsoft365/issues/7176)
- [spo folder archive](../cmd/spo/folder/folder-archive.mdx) - Archives a folder [#7181](https://github.com/pnp/cli-microsoft365/issues/7181)
- [spo list sensitivitylabel remove](../cmd/spo/list/list-sensitivitylabel-remove.mdx) - Clears a default sensitivity label from a document library [#4717](https://github.com/pnp/cli-microsoft365/issues/4717)
...
- [viva engage role member add](../cmd/viva/engage/engage-role-member-add.mdx) - Assign a Viva Engage role to a user [#6819](https://github.com/pnp/cli-microsoft365/issues/6819)
...
- migrated root cli commands to Zod [#7289](https://github.com/pnp/cli-microsoft365/issues/7289)
- migrated connection commands to Zod [#7292](https://github.com/pnp/cli-microsoft365/issues/7292)
- migrated context commands to Zod [#7293](https://github.com/pnp/cli-microsoft365/issues/7293)
- migrated entra multitenant and oauth2grant commands to Zod [#7298](https://github.com/pnp/cli-microsoft365/issues/7298)
- added minimal permissions for `spo app` commands [#6950](https://github.com/pnp/cli-microsoft365/issues/6950)
- updated CLI API usage docs [#5699](https://github.com/pnp/cli-microsoft365/issues/5699)
- enhanced [spe container permission list](../cmd/spe/container/container-permission-list.mdx) command to add a containerName option [#6726](https://github.com/pnp/cli-microsoft365/issues/6726)
- migrated 'cli completion' and 'cli config' commands to Zod [#7290](https://github.com/pnp/cli-microsoft365/issues/7290)
- migrated 'root' commands to Zod [#7291](https://github.com/pnp/cli-microsoft365/issues/7291)
- migrated 'entra administrativeunit member' and 'roleassignment' commands to Zod [#7294](https://github.com/pnp/cli-microsoft365/issues/7294)
- added minimal permissions for 'spo app' commands [#7263](https://github.com/pnp/cli-microsoft365/issues/7263)
- added minimal permissions for 'spo commandset' commands [#7266](https://github.com/pnp/cli-microsoft365/issues/7266)
- added the release notes skill
- migrated entra approleassignment and enterpriseapp commands to Zod [#7295](https://github.com/pnp/cli-microsoft365/issues/7295)
- migrated entra groupsetting and groupsettingtemplate commands to Zod [#7297](https://github.com/pnp/cli-microsoft365/issues/7297)
- migrated entra pim and policy commands to Zod [#7299](https://github.com/pnp/cli-microsoft365/issues/7299)
- migrated `external` commands to Zod [#7302](https://github.com/pnp/cli-microsoft365/issues/7302)
- migrated `file` commands to Zod [#7303](https://github.com/pnp/cli-microsoft365/issues/7303)
- migrated flow commands to Zod [#7304](https://github.com/pnp/cli-microsoft365/issues/7304)
- migrated graph commands to Zod [#7305](https://github.com/pnp/cli-microsoft365/issues/7305)
- migrated entra user commands to Zod validation [#7301](https://github.com/pnp/cli-microsoft365/issues/7301)
- migrated outlook message and mail commands to Zod [#7308](https://github.com/pnp/cli-microsoft365/issues/7308)
- migrated outlook report commands to Zod [#7309](https://github.com/pnp/cli-microsoft365/issues/7309)
- migrated pa commands to Zod schema validation [#7310](https://github.com/pnp/cli-microsoft365/issues/7310)
- migrated planner bucket, plan, and tenant settings set commands to Zod [#7311](https://github.com/pnp/cli-microsoft365/issues/7311)
- migrated onedrive report commands to Zod [#7306](https://github.com/pnp/cli-microsoft365/issues/7306)
- added minimal permissions for 'spo customaction' commands [#7268](https://github.com/pnp/cli-microsoft365/issues/7268)
- updated dev container maintainers
- updated command descriptions to third-person singular
- patched outdated dependencies and update overrides
