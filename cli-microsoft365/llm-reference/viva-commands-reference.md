...
- [engage-role-member-add](#engage-role-member-add)
- [engage-role-member-list](#engage-role-member-list)
- [engage-role-member-remove](#engage-role-member-remove)
...
### Example
```
m365 viva engage role member add --userId EXAMPLE-GUID-PLACEHOLDER --roleName 'Verified Admin'

m365 viva engage role member add --userName john.doe@contoso.com --roleId EXAMPLE-GUID-PLACEHOLDER
...
### Example
```
m365 viva engage role member remove --userId EXAMPLE-GUID-PLACEHOLDER --roleName 'Verified Admin'

m365 viva engage role member remove --userName john.doe@contoso.com --roleId EXAMPLE-GUID-PLACEHOLDER --force
