...
- [calendargroup-remove](#calendargroup-remove)
...
### Example
```
m365 outlook calendargroup remove --id "EXAMPLE_SECRET_VALUE_PLACEHOLDER="

m365 outlook calendargroup remove --name "Personal Events"

m365 outlook calendargroup remove --id "AAMkADIxYjJiYm" --userId "EXAMPLE-GUID-PLACEHOLDER"
...
m365 outlook calendar list --userId EXAMPLE-GUID-PLACEHOLDER --calendarGroupId "EXAMPLE_SECRET_VALUE_PLACEHOLDER="
