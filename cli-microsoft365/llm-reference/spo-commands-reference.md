...
- [brandcenter-colors-list](#brandcenter-colors-list)
- [brandcenter-settings-list](#brandcenter-settings-list)
- [cdn-get](#cdn-get)
...
- [list-defaultvalue-get](#list-defaultvalue-get)
...
- [list-sensitivitylabel-remove](#list-sensitivitylabel-remove)
- [list-set](#list-set)
...
- [site-accessrequest-setting-set](#site-accessrequest-setting-set)
- [site-add](#site-add)
...
- [site-list](#site-list)
- [site-membership-list](#site-membership-list)
...
- [site-unarchive](#site-unarchive)
- [site-versionpolicy-get](#site-versionpolicy-get)
- [spo-get](#spo-get)
...
- [tenant-site-get](#tenant-site-get)
- [term-add](#term-add)
- [term-get](#term-get)
...
- [web-add](#web-add)
- [web-alert-list](#web-alert-list)
- [web-alert-remove](#web-alert-remove)
...
When using the `--clientSideComponentProperties` or `--hostProperties` options it's possible to enter a JSON string. In PowerShell 5 to 7.2 [specific escaping rules](./../../../user-guide/using-cli.mdx#escaping-double-quotes-in-powershell) apply due to an issue. Remember that you can also use [file tokens](./../../../user-guide/using-cli.mdx#EXAMPLE_SECRET_VALUE_PLACEHOLDER) instead.
...
### Example
```
m365 spo file archive --webUrl https://contoso.sharepoint.com/sites/Marketing --id EXAMPLE-GUID-PLACEHOLDER --force
...
### Example
```
m365 spo file unarchive --webUrl https://contoso.sharepoint.com/sites/Marketing --id EXAMPLE-GUID-PLACEHOLDER --force
...
m365 spo file version keep --webUrl "https://contoso.sharepoint.com/sites/marketing" --fileId "EXAMPLE-GUID-PLACEHOLDER" --label "6.0"
...
### Example
```
m365 spo folder archive --webUrl https://contoso.sharepoint.com/sites/Marketing --id EXAMPLE-GUID-PLACEHOLDER --force
...
m365 spo list sensitivitylabel remove --webUrl 'https://contoso.sharepoint.com' --listId 'EXAMPLE-GUID-PLACEHOLDER' --force
...
### Example
```
m365 spo page control remove --webUrl https://contoso.sharepoint.com/sites/Marketing --pageName home.aspx --id EXAMPLE-GUID-PLACEHOLDER

m365 spo page control remove --webUrl https://contoso.sharepoint.com/sites/Marketing --pageName "home.aspx" --id EXAMPLE-GUID-PLACEHOLDER --draft

m365 spo page control remove --webUrl https://contoso.sharepoint.com/sites/Marketing --pageName "Archive/home.aspx" --id EXAMPLE-GUID-PLACEHOLDER
...
When using the `webPartProperties` or `webPartData` options it's possible to enter a JSON string. In PowerShell 5 to 7.2 [specific escaping rules](./../../../user-guide/using-cli.mdx#escaping-double-quotes-in-powershell) apply due to an issue. Remember that you can also use [file tokens](./../../../user-guide/using-cli.mdx#EXAMPLE_SECRET_VALUE_PLACEHOLDER) instead.
...
## site-accessrequest-setting-set
...
m365 spo site hubsite connect --siteUrl https://contoso.sharepoint.com/sites/contoso-sales --id EXAMPLE-GUID-PLACEHOLDER --asAdmin
...
### Example
```
m365 spo tenant site get --id EXAMPLE-GUID-PLACEHOLDER
...
m365 spo term list --termGroupId EXAMPLE-GUID-PLACEHOLDER --termSetId EXAMPLE-GUID-PLACEHOLDER --withChildTerms
...
m365 spo web alert list --webUrl https://contoso.sharepoint.com/sites/Marketing --userId EXAMPLE-GUID-PLACEHOLDER
...
### Example
```
m365 spo web alert remove --webUrl https://contoso.sharepoint.com/sites/Marketing --id EXAMPLE-GUID-PLACEHOLDER

m365 spo web alert remove --webUrl https://contoso.sharepoint.com/sites/Marketing --id EXAMPLE-GUID-PLACEHOLDER --force
